...
function Explorer.new(x, y)
    ...
    self.allProjects = {
        ...
        {name = "Copia de documentos", desc = "Digitalizar 300 documentos\ncon scanner.", baseHp = 400, days = 14, reward = 400, difficulty = "normal"},
        {name = "Inventario de almacen", desc = "Inventariar productos\ndel almacen.", baseHp = 400, days = 14, reward = 450, difficulty = "normal"},
        {name = "Procesamiento de nominas", desc = "Calcular nominas de\n50 empleados.", baseHp = 400, days = 14, reward = 550, difficulty = "normal"},
        {name = "Help Desk interno", desc = "Resolver tickets de soporte\ninterno.", baseHp = 400, days = 14, reward = 500, difficulty = "normal"},
        {name = "Redaccion de cartas", desc = "Redactar 50 cartas\ncomerciales.", baseHp = 400, days = 14, reward = 600, difficulty = "normal"},
