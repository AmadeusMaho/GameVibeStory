...
function Explorer.new(x, y)
    ...
    self.allProjects = {
        {name = "Ordenar escritorio", desc = "Organizar papeles\ny limpiar escritorio.", baseHp = 30, days = 14, reward = 50, difficulty = "muy_facil"},
        {name = "Archivar recibos", desc = "Guardar 50 recibos\nen carpetas.", baseHp = 30, days = 14, reward = 60, difficulty = "muy_facil"},
        {name = "Copiar documentos", desc = "Hacer 20 copias\nde formularios.", baseHp = 30, days = 14, reward = 70, difficulty = "muy_facil"},
        {name = "Digitacion de formularios", desc = "Digitar 200 formularios\nde seguros.", baseHp = 60, days = 14, reward = 150, difficulty = "facil"},
        {name = "Clasificacion de archivos", desc = "Clasificar 500 archivos\npor categoria y fecha.", baseHp = 60, days = 14, reward = 180, difficulty = "facil"},
        {name = "Traduccion de documentos", desc = "Traducir 10 documentos\nlegales al espanol.", baseHp = 60, days = 14, reward = 200, difficulty = "facil"},
        {name = "Soporte tecnico", desc = "Dar soporte tecnico\npor telefono a clientes.", baseHp = 60, days = 14, reward = 220, difficulty = "facil"},
        {name = "Revision de facturas", desc = "Revisar 150 facturas\npor errores.", baseHp = 60, days = 14, reward = 250, difficulty = "facil"},
        ...
        {name = "Archivo de correspondencia", desc = "Archivar 400 cartas\ny documentos.", baseHp = 300, days = 14, reward = 800, difficulty = "dificil"},
        {name = "Base de datos de clientes", desc = "Crear BD de 200 clientes\nen Access.", baseHp = 300, days = 14, reward = 1000, difficulty = "dificil"},
        {name = "Revision de impresiones", desc = "Revisar documentos\nimpresos por erratas.", baseHp = 300, days = 14, reward = 900, difficulty = "dificil"},
        {name = "Base de datos Access", desc = "Crear sistema de inventario\npara empresa local.", baseHp = 300, days = 14, reward = 1200, difficulty = "dificil"},
        {name = "Pagina web corporativa", desc = "Diseno de sitio web\ncon HTML y tablas.", baseHp = 300, days = 14, reward = 1500, difficulty = "dificil"},
        {name = "Reporte de nominas", desc = "Sistema de nomina\nen Hoja de calculo.", baseHp = 550, days = 14, reward = 2500, difficulty = "muy_dificil"},
        {name = "Presentacion multimedia", desc = "Slides con animaciones\ny transiciones.", baseHp = 550, days = 14, reward = 3000, difficulty = "muy_dificil"},
        {name = "Soporte de red", desc = "Configurar red local\nentre 5 computadoras.", baseHp = 550, days = 14, reward = 3500, difficulty = "muy_dificil"},
        {name = "App de inventario", desc = "Programa de control\nde stock en Visual Basic.", baseHp = 550, days = 14, reward = 5000, difficulty = "muy_dificil"},
        {name = "Compilador basico", desc = "Crear compilador para\nlenguaje simple.", baseHp = 850, days = 14, reward = 7000, difficulty = "extremo"},
        {name = "Servidor web", desc = "Montar servidor HTTP\ncon CGI scripts.", baseHp = 850, days = 14, reward = 8500, difficulty = "extremo"},
        {name = "Motor de busqueda", desc = "Indexador de paginas\nweb con spiders.", baseHp = 850, days = 14, reward = 10000, difficulty = "extremo"},
        {name = "Sistema de facturacion", desc = "Generador de facturas\ncon base de datos.", baseHp = 1100, days = 14, reward = 8000, difficulty = "pesadilla"},
        {name = "Conversor de formatos", desc = "Herramienta para convertir\narchivos entre formatos.", baseHp = 1100, days = 14, reward = 10000, difficulty = "pesadilla"},
        {name = "Editor de codigo fuente", desc = "IDE con resaltado\nde sintaxis.", baseHp = 1500, days = 14, reward = 15000, difficulty = "inframundo"},
        {name = "Cliente de correo", desc = "Cliente SMTP/POP3\ncon interfaz grafica.", baseHp = 1500, days = 14, reward = 18000, difficulty = "inframundo"},
        {name = "Anti-virus", desc = "Escaneador de virus\ncon firmas actualizadas.", baseHp = 1500, days = 14, reward = 22000, difficulty = "inframundo"},
        {name = "Sistema operativo", desc = "Kernel con multitarea\ny sistema de archivos.", baseHp = 1800, days = 14, reward = 30000, difficulty = "infierno"},
        {name = "Base de datos relacional", desc = "Motor SQL completo\ncon transacciones.", baseHp = 1800, days = 14, reward = 35000, difficulty = "infierno"},
        {name = "Navegador web", desc = "Browser con motor\nrender HTML 3.2.", baseHp = 1800, days = 14, reward = 40000, difficulty = "infierno"},
    }
