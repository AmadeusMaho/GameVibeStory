...
function Explorer.new(x, y)
    ...
    self.allProjects = {
        ...
        {name = "Digitacion de formularios", desc = "Digitar 200 formularios\nde seguros.", baseHp = 100, days = 14, reward = 150, difficulty = "facil"},
        {name = "Clasificacion de archivos", desc = "Clasificar 500 archivos\npor categoria y fecha.", baseHp = 100, days = 14, reward = 180, difficulty = "facil"},
        {name = "Traduccion de documentos", desc = "Traducir 10 documentos\nlegales al espanol.", baseHp = 100, days = 14, reward = 200, difficulty = "facil"},
        {name = "Soporte tecnico", desc = "Dar soporte tecnico\npor telefono a clientes.", baseHp = 100, days = 14, reward = 220, difficulty = "facil"},
        {name = "Revision de facturas", desc = "Revisar 150 facturas\npor errores.", baseHp = 100, days = 14, reward = 250, difficulty = "facil"},
        {name = "Copia de documentos", desc = "Digitalizar 300 documentos\ncon scanner.", baseHp = 250, days = 14, reward = 400, difficulty = "normal"},
        {name = "Inventario de almacen", desc = "Inventariar productos\ndel almacen.", baseHp = 250, days = 14, reward = 450, difficulty = "normal"},
        {name = "Procesamiento de nominas", desc = "Calcular nominas de\n50 empleados.", baseHp = 250, days = 14, reward = 550, difficulty = "normal"},
        {name = "Help Desk interno", desc = "Resolver tickets de soporte\ninterno.", baseHp = 250, days = 14, reward = 500, difficulty = "normal"},
        {name = "Redaccion de cartas", desc = "Redactar 50 cartas\ncomerciales.", baseHp = 250, days = 14, reward = 600, difficulty = "normal"},
        {name = "Archivo de correspondencia", desc = "Archivar 400 cartas\ny documentos.", baseHp = 700, days = 14, reward = 800, difficulty = "dificil"},
        {name = "Base de datos de clientes", desc = "Crear BD de 200 clientes\nen Access.", baseHp = 700, days = 14, reward = 1000, difficulty = "dificil"},
        {name = "Revision de impresiones", desc = "Revisar documentos\nimpresos por erratas.", baseHp = 700, days = 14, reward = 900, difficulty = "dificil"},
        {name = "Base de datos Access", desc = "Crear sistema de inventario\npara empresa local.", baseHp = 700, days = 14, reward = 1200, difficulty = "dificil"},
        {name = "Pagina web corporativa", desc = "Diseno de sitio web\ncon HTML y tablas.", baseHp = 700, days = 14, reward = 1500, difficulty = "dificil"},
        {name = "Reporte de nominas", desc = "Sistema de nomina\nen Hoja de calculo.", baseHp = 1100, days = 14, reward = 2500, difficulty = "muy_dificil"},
