...
local componentDefs = {
    gpu = {
        ...
        basePower = 3,
        tiers = {
            {interval = 3.2, power = 3},
            {interval = 2.7, power = 5},
            {interval = 2.2, power = 8},
            {interval = 1.9, power = 11},
            {interval = 1.6, power = 14},
            {interval = 1.3, power = 18},
            {interval = 1.0, power = 22},
        },
    ...
    cpu = {
        ...
        basePower = 2,
        tiers = {
            {interval = 4.5, power = 2},
            {interval = 4.0, power = 3},
            {interval = 3.5, power = 5},
            {interval = 3.0, power = 7},
            {interval = 2.5, power = 9},
            {interval = 2.0, power = 12},
            {interval = 1.5, power = 15},
        },
    ...
    ram = {
        ...
        basePower = 0,
        tiers = {
            {interval = 6.5, power = 0},
            {interval = 5.5, power = 2},
            {interval = 4.5, power = 4},
            {interval = 4.0, power = 6},
            {interval = 3.5, power = 8},
            {interval = 3.0, power = 11},
            {interval = 2.5, power = 14},
        },
    ...
    cooling = {
        ...
        basePower = 0,
        tiers = {
            {interval = 7.5, power = 0},
            {interval = 6.5, power = 2},
            {interval = 5.5, power = 4},
            {interval = 5.0, power = 6},
            {interval = 4.5, power = 8},
            {interval = 4.0, power = 11},
            {interval = 3.5, power = 14},
        },
